...
function WH2010_comment($comment, $args, $depth) {
   $GLOBALS['comment'] = $comment; ?>
   <li <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
        <?php if ($comment->comment_approved == '0') : ?>
            <p><em><?php _e('Your comment is awaiting moderation.') ?></em></p>
        <?php endif; ?>
		<cite><?php printf(__('<strong>%1$s at %2$s</strong>'), get_comment_date(),  get_comment_time()) ?><?php edit_comment_link(__('(Edit)'),'  ','') ?><?php printf(__(' | by %s'), get_comment_author()) ?></cite>
...
add_action( 'init', 'create_covers' );
function create_covers() {
  $labels = array(
    'name' => _x('Covers', 'post type general name'),
    'singular_name' => _x('Cover', 'post type singular name'),
    'add_new' => _x('Add New', 'Cover'),
    'add_new_item' => __('Add New Cover'),
    'edit_item' => __('Edit Cover'),
    'new_item' => __('New Cover'),
    'view_item' => __('View Cover'),
    'search_items' => __('Search Covers'),
    'not_found' =>  __('No Covers found'),
    'not_found_in_trash' => __('No Covers found in Trash'),
    'parent_item_colon' => ''
  );
