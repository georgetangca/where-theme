...
<div id="footer">
            ...
            <div class="container">
                ...
                <div class="col destinations">
                    ...
                    <ul class="stylized col2">
                        ...
                        <li><span class="number">10</span><a href="/central-canada/ontario/muskoka/">Muskoka</a></li>
                        <li><span class="number">11</span><a href="/west-coast/british-columbia/whistler/">Whistler</a></li>
                        <li><span class="number">12</span><a href="/yukon/">Yukon</a></li>
                    </ul>
                </div>
                <div class="col">
                    ...
                    <ol>   
                        <?php
                        global $post;
                        $myposts = get_posts('numberposts=5&category=8263'); 
        ...
        <div id="footer-ads">        
            ...
            <?php include("openx_ads_bottom.php");?>
