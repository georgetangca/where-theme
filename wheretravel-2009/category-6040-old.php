...
<img id="location-photo" src="/titleimages/h11_rockies.jpg" />
	...
	<div id="content2">
		...
		<!--The inline margin-left below is to accomodate the map above until a description is added -->
        <div id="travel-guides" >
            <h4><strong>STAY, DINE, DO:</strong> Find a hotel, restaurant or attraction.</h4>
            <p>Listings to get the most out of your visit: where to dine, what to see, where to shop, and more.</p>
            <ul>                  
             
			<?php
			$listing_cat_id = '4351';
			$listing_cat_id_parent = '3742';
